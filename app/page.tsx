...
export default function Home() {
  ...
  useEffect(() => {
    if (!isLoading) {
      ...
      else if (user && (user.role === "partner" || user.role === "reseller" || user.role === "seller")) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100">
      <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white p-10 shadow-lg">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900">
            Rifat Dashboard
          </h1>
          <p className="mt-2 text-sm text-gray-600">
            Sign in to manage your products and operations
          </p>
        </div>
